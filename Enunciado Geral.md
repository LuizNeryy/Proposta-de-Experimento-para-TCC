...
## Divisão das entregas (levar em conta apenas o que pede)

### Entrega 1: Identificação Básica, Contexto e Problema
**Vencimento:** 21 nov por 23:59 | **Pontos:** 2 | **Formato:** URL de site

**Formato da entrega:**

- Link do Git contendo arquivo .md com texto preenchido
- Seguir orientações dadas em sala de aula pelo professor

---

### Entrega 2: Escopo, Objetivo, Stakeholders/Impacto, Riscos de alto nível, premissas e critérios de sucesso
**Vencimento:** 25 nov por 23:59 | **Pontos:** 2 | **Formato:** URL de site

**Formato da entrega:**
- Link do Git contendo arquivo .md com texto preenchido
- O texto deve incluir o template do escopo conforme visto em sala
- O texto deve incluir uma tabela do GQM com colunas de objetivo, perguntas e métricas
- O texto deve incluir uma tabela de todas as métricas, com uma coluna de descrição da métrica e outra coluna de unidade
- Pelo menos 4 objetivos específicos
- Pelo menos 3 perguntas por objetivo
- Pelo menos 2 métricas associadas por pergunta
- As métricas podem repetir para perguntas diferentes, porém no total, deve haver pelo menos 10 métricas diferentes
- Seguir orientações dadas em sala de aula pelo professor

---

### Entrega 3: Modelo conceitual e hipóteses; Variáveis, fatores, tratamentos e objetos de estudo; Desenho experimental
**Vencimento:** 28 nov por 23:59 | **Pontos:** 2 | **Formato:** Caixa de entrada de texto

**Formato da entrega:**
- Link do Git contendo arquivo .md com texto preenchido
- O texto deve incluir uma tabela com as variáveis e suas descrições
- O texto deve incluir uma tabela com os fatores e seus tratamentos e suas combinações, se houver
- Seguir orientações dadas em sala de aula pelo professor

---

### Entrega 4: População, sujeitos e amostragem; Instrumentação e protocolo operacional; Plano de análise de dados (pré-execução)
**Vencimento:** Terça-feira por 23:59 | **Pontos:** 2 | **Formato:** Caixa de entrada de texto

**Formato da entrega:**
- Link do Git contendo arquivo .md com texto preenchido e atualizado
- Incluir no texto um fluxograma do passo a passo do experimento, contendo cada um dos passos necessários para o experimento ocorrer no que tange à sua operacionalização
- Aqui vale citar instrumentos, variáveis, métricas, stakeholders, etc.

---

### Entrega 5: Avaliação de validade (ameaças e mitigação)
**Vencimento:** Sexta-feira por 23:59 | **Pontos:** 2 | **Formato:** URL de site

**Formato da entrega:**
- Link do Git contendo arquivo .md com texto atualizado
- Vídeo de 3 a 5 minutos onde o aluno detalha as ameaças à validade do seu experimento, contendo:
  - 1 minuto de apresentação oral do aluno: um overview às ameaças/validade
  - 3 minutos de apresentação de slides: 1 slide por ameaça identificada, com as devidas categorizações da ameaça
  - 1 minuto final de encerramento do aluno, sem slides, recapitulando as ações que serão tomadas para contornar ou mitigar as ameaças

---

### Entrega Final: Apresentação e Entrega final do PLANEJAMENTO DE EXPERIMENTO em md
**Vencimento:** 12 dez por 23:59 | **Pontos:** 10 | **Formato:** URL de site

Nenhum detalhe adicional foi adicionado para esta tarefa.